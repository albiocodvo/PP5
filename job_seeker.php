    ...
    <section class="bg-gray-50 dark:bg-gray-900 py-16">
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <img class="mx-auto" src="./assets/images/tvac-logo-1.png" alt="The Virtual Aid Co. Logo" style="height: 170px; width: auto;">
                <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Job Seeker Login</h2>
            </div>
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <form class="space-y-6" method="POST">
                    ...
                    <div>
                        <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Login as Job Seeker</button>
                    </div>
                </form>

                <p class="mt-10 text-center text-sm text-gray-500">
                    Not a member?
                    <a href="create_user.php" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Register Now!</a>
                </p>
            </div>
        </div>
    </section>
